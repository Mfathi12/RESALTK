...
router.get('/user/:userId/services',Authentication,validate(ServicesSchema.GetUserServices),ServicesController.GetUserServices)
router.patch('admin/assign-provider/:serviceId', Authentication, Authorization("admin"),validate(ServicesSchema.AssignProviderByAdmin),ServicesController.AssignProviderByAdmin);
